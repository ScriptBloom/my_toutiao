...
public class ArrowRefresh extends LinearLayout implements IRefresh {
    ...
    public ArrowRefresh(Context context) {
        this(context,null);
    }

    public ArrowRefresh(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ArrowRefresh(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public ArrowRefresh(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        mContentLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.item_refresh_header, null);
